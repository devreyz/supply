...
return [
    ...
    | pela classe de validador. Algumas dessas regras têm versões múltiplas,
    | como as regras de tamanho. Fique à vontade para ajustar cada uma dessas
    | mensagens aqui.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O campo :attribute foi comprometido em uma violação de dados. Por favor, escolha um :attribute diferente.',
    ],
    'present' => 'O campo :attribute deve estar presente.',
    'prohibited' => 'O campo :attribute é proibido.',
    'prohibited_if' => 'O campo :attribute é proibido quando :other for :value.',
    'prohibited_unless' => 'O campo :attribute é proibido, a menos que :other seja :value.',
    'prohibits' => 'O campo :attribute proíbe :other de ser presente.',
