import{a as A,H as b}from"./vendor-CCKSAvAt.js";import{I,J as T}from"./queue-DX9w-n4L.js";window.axios=A;window.axios.defaults.headers.common["X-Requested-With"]="XMLHttpRequest";class y{constructor(e="spa_"){this.prefix=e,this._cache=new Map,this._watchers=new Map}_key(e){return`${this.prefix}${e}`}get(e,t=null){if(this._cache.has(e))return this._cache.get(e);try{const s=localStorage.getItem(this._key(e));if(s===null)return t;const i=JSON.parse(s);return this._cache.set(e,i),i}catch(s){return console.warn(`Erro ao ler localStorage[${e}]:`,s),t}}set(e,t){try{const s=JSON.stringify(t);return localStorage.setItem(this._key(e),s),this._cache.set(e,t),this._notify(e,t),!0}catch(s){return console.error(`Erro ao salvar localStorage[${e}]:`,s),!1}}remove(e){return localStorage.removeItem(this._key(e)),this._cache.delete(e),this._notify(e,null),!0}has(e){return localStorage.getItem(this._key(e))!==null}keys(){const e=[];for(let t=0;t<localStorage.length;t++){const s=localStorage.key(t);s.startsWith(this.prefix)&&e.push(s.substring(this.prefix.length))}return e}all(){const e={};return this.keys().forEach(t=>{e[t]=this.get(t)}),e}clear(){return this.keys().forEach(e=>{this.remove(e)}),this._cache.clear(),!0}async remember(e,t){if(this.has(e))return this.get(e);const s=typeof t=="function"?await t():t;return this.set(e,s),s}increment(e,t=1){const s=this.get(e,0),i=(Number(s)||0)+t;return this.set(e,i),i}decrement(e,t=1){return this.increment(e,-t)}push(e,t){const s=this.get(e,[]);if(!Array.isArray(s))throw new Error(`${e} não é um array`);return s.push(t),this.set(e,s),s}pop(e){const t=this.get(e,[]);if(!Array.isArray(t))throw new Error(`${e} não é um array`);const s=t.pop();return this.set(e,t),s}setNested(e,t,s){const i=this.get(e,{}),a=t.split(".");let n=i;for(let o=0;o<a.length-1;o++)a[o]in n||(n[a[o]]={}),n=n[a[o]];return n[a[a.length-1]]=s,this.set(e,i),i}getNested(e,t,s=null){const i=this.get(e,{}),a=t.split(".");let n=i;for(const o of a)if(n&&typeof n=="object"&&o in n)n=n[o];else return s;return n}watch(e,t){return this._watchers.has(e)||this._watchers.set(e,new Set),this._watchers.get(e).add(t),()=>{const s=this._watchers.get(e);s&&s.delete(t)}}_notify(e,t){const s=this._watchers.get(e);if(s){const i=this._cache.get(e);s.forEach(a=>{try{a(t,i)}catch(n){console.error("Erro no watcher:",n)}})}}setWithExpiry(e,t,s){const i={value:t,expiry:Date.now()+s*1e3};return this.set(e,i)}getWithExpiry(e,t=null){const s=this.get(e);return s?s.expiry&&Date.now()>s.expiry?(this.remove(e),t):s.value:t}export(){return JSON.stringify(this.all(),null,2)}import(e){const t=JSON.parse(e);return Object.entries(t).forEach(([s,i])=>{this.set(s,i)}),!0}size(){let e=0;return this.keys().forEach(t=>{const s=localStorage.getItem(this._key(t));s&&(e+=s.length*2)}),e}isNearLimit(e=.9){const t=this.size(),s=5*1024*1024;return t>=s*e}}const O=new y("spa_");typeof window<"u"&&(window.LocalStorageORM=y,window.Storage=O);class E{constructor(e={},t={}){e&&typeof e.modal=="function"?(this.spa=e,this.options={showBanner:!0,bannerDelay:5e3,bannerDismissKey:"spa_pwa_dismissed",serviceWorker:"./service-worker.js",...t}):(this.spa=null,this.options={showBanner:!0,bannerDelay:5e3,bannerDismissKey:"spa_pwa_dismissed",serviceWorker:"./service-worker.js",...e}),this.deferredPrompt=null,this.isInstalled=!1,this.isStandalone=!1,this.isShowingPrompt=!1,this.hasAttemptedPrompt=!1,this.installationPending=!1,this.promptTimeout=null,this._init()}async _showIOSInstallModal(){if(this.isInstalled||this.isShowingPrompt)return;this.isShowingPrompt=!0;const e=this.options.installHtml||`
    ...
    `,s=this.options.installHtml||t;try{const i={title:this.options.installTitle||"Instalar Aplicativo",html:s,type:"custom",closeOnBackdrop:!1,width:this.options.installWidth||"480px",customButtons:[{text:this.options.cancelText||"Agora não",class:"btn btn-outline",value:"cancel"},{text:this.options.installText||"Instalar Agora",class:"btn btn-success",value:"ok"}]},n=await this.spa.modal(i);if(this.isShowingPrompt=!1,n==="ok")if(await this.promptInstall()){this.installationPending=!0;try{this.spa&&typeof this.spa.toastInfo=="function"?this.spa.toastInfo("Instalação iniciada","Aguarde enquanto o sistema finaliza a instalação."):this.spa&&typeof this.spa.toast=="function"?this.spa.toast("Instalação iniciada — aguardando confirmação."):console.log("📱 PWA: Instalação iniciada — aguardando evento appinstalled.")}catch{}}else this._dismiss();else this._dismiss()}catch(i){this.isShowingPrompt=!1,console.error("📱 PWA: Falha ao abrir modal de instalação, usando banner como fallback",i),this._showBanner()}}_showBanner(){if(this.isInstalled||!this.canInstall()||this.isShowingPrompt)return;this._hideBanner(),this.isShowingPrompt=!0;const e=document.createElement("div");e.id="pwa-install-banner",e.className="pwa-banner",e.innerHTML=`
            ...
            `,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("active")}),setTimeout(()=>{i.classList.remove("active"),setTimeout(()=>i.remove(),300)},s),i}hideLoading(){this.loadingOverlay&&this.loadingOverlay.classList.add("hidden")}toggleTheme(){const t=(document.documentElement.dataset.theme||"light")==="light"?"dark":"light";return this.setTheme(t),t}setTheme(e){document.documentElement.dataset.theme=e,this.storage.set("pref_theme",e),window.lucide&&window.lucide.createIcons(),document.querySelectorAll("#theme-toggle-sheet, .theme-toggle").forEach(s=>s.checked=e==="dark"),this._log(2,`🌓 Tema alterado para: ${e}`)}setAnimation(e){this.config.animation.type=e,document.documentElement.dataset.animation=e,this.storage.set("pref_animation",e),document.querySelectorAll(".animation-select").forEach(s=>s.value=e),this.toastInfo("Animação Alterada",`Estilo "${e}" aplicado com sucesso.`),this._log(2,`🎬 Animação alterada para: ${e}`)}_applyPreferences(){const e=this.storage.get("pref_theme");e?this.setTheme(e):this.config.ui.autoTheme&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches&&this.setTheme("dark");const t=this.storage.get("pref_animation");t&&(this.config.animation.type=t,document.documentElement.dataset.animation=t,document.querySelectorAll(".animation-select").forEach(i=>i.value=t)),this._log(2,"⚙️ Preferências aplicadas")}openModal(e){return this.modal(e)}async logout(){var e;try{this.showLoading();const t=document.createElement("form");t.method="POST",t.action="/logout";const s=(e=document.querySelector('meta[name="csrf-token"]'))==null?void 0:e.content;if(s){const i=document.createElement("input");i.type="hidden",i.name="_token",i.value=s,t.appendChild(i)}document.body.appendChild(t),t.submit()}catch{this.hideLoading(),this.toastError("Erro ao sair","Não foi possível realizar o logout.")}}get db(){return this._db}set db(e){this._db=e}get storage(){return this._storage}set storage(e){this._storage=e}get queue(){return this._queue}set queue(e){this._queue=e}_registerPages(){document.querySelectorAll(".page").forEach(e=>{let t=e.id;t.startsWith(this.config.pagePrefix)&&(t=t.substring(this.config.pagePrefix.length)),this.pages.set(t,e);const s=e.dataset.level||"primary",i=e.dataset.parent||this.config.homePage,a=e.dataset.keepHistory==="true";this.pageHierarchy.set(t,{level:s,parent:i,keepHistory:a,element:e}),e.classList.contains("active")&&(this.current=t)})}_createElements(){this.backdrop=document.getElementById("backdrop"),this.backdrop||(this.backdrop=document.createElement("div"),this.backdrop.id="backdrop",document.body.appendChild(this.backdrop)),this._createToastContainer(),this.loadingOverlay=document.getElementById("loading-overlay")}_createToastContainer(){this.toastContainer=document.getElementById("toast-container"),this.toastContainer||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className=`toast-container toast-${this.config.ui.toast.position}`,document.body.appendChild(this.toastContainer))}_initManagers(){this.drawerManager=new x(this),this.sheetManager=new k(this),this.modalManager=new P(this),this.multiStepManager=new B(this),document.querySelectorAll(".drawer").forEach(e=>{this.drawerManager.register(e.id)}),document.querySelectorAll(".bottom-sheet").forEach(e=>{this.sheetManager.register(e.id)}),document.querySelectorAll("[data-multistep-sheet]").forEach(e=>{this.sheetManager&&this.sheetManager.register(e.id),this.multiStepManager&&this.multiStepManager.register(e.id)}),requestAnimationFrame(()=>{window.lucide&&window.lucide.createIcons()})}_setupEventListeners(){window.addEventListener("popstate",this._handlePopState),document.addEventListener("click",this._handleClick),this.backdrop&&this.config.ui.backdrop.closeOnClick&&this.backdrop.addEventListener("click",()=>{this.activeOverlays.length>0&&this.closeTopOverlay()}),document.addEventListener("keydown",e=>{e.key==="Escape"&&this.activeOverlays.length>0&&this.closeTopOverlay(),e.altKey&&e.key==="ArrowLeft"&&this.back()}),window.addEventListener("online",this._handleOnline),window.addEventListener("offline",this._handleOffline),this.config.doubleTapExit&&window.addEventListener("popstate",this._handleDoubleTapExit.bind(this))}_handleClick(e){const t=e.target,s=t.closest("[data-go]");if(s){e.preventDefault();const d=s.closest(".drawer"),l=s.closest(".bottom-sheet"),h=s.closest(".modal");if(d&&this.drawerManager&&typeof this.drawerManager.close=="function")try{this.drawerManager.close(d.id,!1)}catch{this._closeOverlay(`drawer-${d.id}`,!1)}else if(l&&this.sheetManager&&typeof this.sheetManager.close=="function")try{this.sheetManager.close(l.id,!1)}catch{this._closeOverlay(`sheet-${l.id}`,!1)}else if(h&&this.modalManager&&typeof this.modalManager.close=="function")try{this.modalManager.close(h.id)}catch{this._closeOverlay(`modal-${h.id}`,!1)}this.go(s.dataset.go);return}if(t.closest("[data-back]")){e.preventDefault(),this.back(e);return}const a=t.closest("[data-drawer]");if(a){e.preventDefault(),this.openDrawer(a.dataset.drawer);return}const n=t.closest("[data-sheet]");if(n){e.preventDefault(),this.openSheet(n.dataset.sheet);return}const o=t.closest("[data-modal]");if(o){e.preventDefault();const d=o.dataset.modal;document.getElementById(d)&&this.modal({template:d});return}if(t.closest("[data-close-overlay]")){e.preventDefault(),this.closeTopOverlay();return}}_handlePopState(e){this._log(2,"⬅️ Popstate detectado");let t,s=[];if(e.state&&e.state.page)t=e.state.page,s=e.state.overlays||[];else{const c=window.location.hash.slice(1);t=c&&this.pages.has(c)?c:this.config.homePage}if(this._log(2,`⬅️ Indo para: ${t}`),s.length<this.activeOverlays.length){const c=this.activeOverlays[this.activeOverlays.length-1];this._closeOverlay(c,!1);return}if(t===this.current)return;const i=this.pages.get(this.current),a=this.pages.get(t);if(!a)return;try{this._prepareBindingsForNavigation(t)}catch{}document.documentElement.dataset.animation=this.config.animation.type;const n=this.config.animation&&this.config.animation.backSpeed||Math.max(this.config.animation.speed/3,.06),o=getComputedStyle(document.documentElement).getPropertyValue("--spa-animation-speed")||this.config.animation.speed+"s";document.documentElement.style.setProperty("--spa-animation-speed",n+"s"),this._emitPageEvent(this.current,"page:leave"),this._clearPageClasses(i,a),i.classList.remove("active"),a.classList.add("revealing"),this.previousPage=this.current,this.current=t,setTimeout(()=>{a.classList.remove("revealing"),a.classList.add("active"),this._emitPageEvent(t,"page:enter"),document.documentElement.style.setProperty("--spa-animation-speed",o.trim()||this.config.animation.speed+"s")},n*1e3)}_handleDoubleTapExit(e){if(!this.config.doubleTapExit)return;const t=e.state;if(t&&t.type==="exit"){const s=Date.now();s-this.lastBackPress<this.config.doubleTapTimeout?window.close():(this.lastBackPress=s,this.toast("Pressione voltar novamente para sair","info"),history.pushState({page:this.current,overlays:[],type:"home"},"",`#${this.current}`))}}_handleOnline(){this._online=!0,this.toast("🌐 Conexão restaurada","success"),this._emit("spa:online"),this.queue&&this.queue.processAll()}_handleOffline(){this._online=!1,this.toast("📴 Você está offline","warning"),this._emit("spa:offline")}get isOnline(){return this._online}_setupInitialHistory(){const e=window.location.hash.substring(1);if(e&&this.pages.has(e)&&(this.current=e,this.pages.forEach((s,i)=>{s.classList.toggle("active",i===e)})),["_modal","_sheet","_drawer"].some(s=>e.includes(s))){const s=e.split(/_(modal|sheet|drawer)/)[0];this.pages.has(s)&&(this.current=s,this.pages.forEach((i,a)=>{i.classList.toggle("active",a===s)}))}if(!history.state||!history.state.page){const s=this.pageHierarchy.get(this.current);history.replaceState({page:this.current,overlays:[],type:(s==null?void 0:s.level)||"home"},"",`#${this.current}`)}}async _initStorage(){try{this._db=new I(this.config.db.name,this.config.db.version),await this._db.init(),this._log(2,"💾 IndexedDB inicializado"),this._storage=new y(this.config.storage.prefix),this._log(2,"💾 localStorage inicializado"),this._queue=new T(this._db),await this._queue.init(),this._log(2,"📋 Job Queue inicializada")}catch(e){console.error("Erro ao inicializar storage:",e),this._emit("spa:error",{error:e})}}_initPWA(){this.config.pwa&&this.config.pwa.enabled&&(this.pwa=new E(this,this.config.pwa)),this.notifications=new S(this),typeof this.notifications.init=="function"&&this.notifications.init()}_clearPageClasses(e,t){const s=["active","prev","revealing"];e&&e.classList.remove(...s),t&&t.classList.remove(...s)}_showBackdrop(){this.backdrop&&this.backdrop.classList.add("show")}_hideBackdrop(){this.backdrop&&this.backdrop.classList.remove("show")}_emit(e,t={}){const s=new CustomEvent(e,{detail:t});document.dispatchEvent(s)}_emitPageEvent(e,t){const s=this.pages.get(e);if(s){const i=new CustomEvent(t,{detail:{pageId:e,element:s}});s.dispatchEvent(i),document.dispatchEvent(i)}t==="page:enter"&&this._updatePageBindings()}_getLevelValue(e){const t={home:0,primary:1,secondary:2,tertiary:3};return t[e]!==void 0?t[e]:1}_prepareBindingsForNavigation(e){document.querySelectorAll("[data-show-on]").forEach(t=>{t.dataset.showOn.split(",").map(i=>i.trim()).includes(e)||(t.style.opacity="0",t.style.pointerEvents="none",t.setAttribute("disabled","true"))}),document.querySelectorAll("[data-hide-on]").forEach(t=>{t.dataset.hideOn.split(",").map(i=>i.trim()).includes(e)&&(t.style.opacity="0",t.style.pointerEvents="none",t.setAttribute("disabled","true"))})}_updatePageBindings(){const e=this.current;document.querySelectorAll("[data-show-on]").forEach(t=>{t.dataset.showOn.split(",").map(i=>i.trim()).includes(e)?(t.style.display="",t.style.opacity="",t.style.pointerEvents="",t.removeAttribute("disabled"),t.classList.remove("hidden")):(t.style.display="none",t.classList.add("hidden"))}),document.querySelectorAll("[data-hide-on]").forEach(t=>{t.dataset.hideOn.split(",").map(i=>i.trim()).includes(e)?(t.style.display="none",t.classList.add("hidden")):(t.style.display="",t.style.opacity="",t.style.pointerEvents="",t.removeAttribute("disabled"),t.classList.remove("hidden"))}),document.querySelectorAll("[data-active-on]").forEach(t=>{t.dataset.activeOn.split(",").map(i=>i.trim()).includes(e)?t.classList.add("active"):t.classList.remove("active")}),document.querySelectorAll("[data-go]").forEach(t=>{t.dataset.go===e?t.classList.add("active"):t.classList.remove("active")})}_log(e,t,s=null){this.config.debug.enabled&&(e>this.config.debug.level||(s?console.log(t,s):console.log(t)))}_deepMerge(e,t){const s=Object.assign({},e);return this._isObject(e)&&this._isObject(t)&&Object.keys(t).forEach(i=>{this._isObject(t[i])?i in e?s[i]=this._deepMerge(e[i],t[i]):Object.assign(s,{[i]:t[i]}):Object.assign(s,{[i]:t[i]})}),s}_isObject(e){return e&&typeof e=="object"&&!Array.isArray(e)}destroy(){window.removeEventListener("popstate",this._handlePopState),document.removeEventListener("click",this._handleClick),window.removeEventListener("online",this._handleOnline),window.removeEventListener("offline",this._handleOffline),this.pages.clear(),this.pageHierarchy.clear(),this.activeOverlays=[],this._log(1,"🗑️ SPA Framework destruído")}}typeof window<"u"&&(window.SPA=C);function q(r){$(),j()}function $(r){N()}function N(){var t,s;const r=((t=window.SPA_CONFIG)==null?void 0:t.cities)||["Uberlândia","Uberaba","Araguari"],e=((s=window.SPA_CONFIG)==null?void 0:s.insurances)||["Unimed","Bradesco","Particular"];_("whatsapp-cities",r,"whatsapp-city"),_("whatsapp-insurances",e,"whatsapp-insurance")}function _(r,e,t){const s=document.getElementById(r);s&&(s.innerHTML="",e.forEach(i=>{const a=document.createElement("button");a.type="button",a.className="px-3 py-1.5 rounded-full border text-sm bg-white hover:bg-slate-50 transition-colors",a.textContent=i,a.dataset.value=i,a.onclick=()=>{Array.from(s.children).forEach(o=>{o.classList.remove("ring-2","ring-red-400","bg-red-50")}),a.classList.add("ring-2","ring-red-400","bg-red-50");const n=document.getElementById(t);n&&(n.value=i)},s.appendChild(a)}))}function z(r,e){const t=window.app,s=document.getElementById("whatsapp-topic");s&&(s.value=e);const i=document.getElementById("whatsapp-intent");i&&(i.value=r);const a=document.getElementById("whatsapp-dob-row");a&&(a.style.display=e==="results"?"block":"none"),t==null||t.closeSheet(),setTimeout(()=>{t==null||t.openSheet("tpl-sheet-whatsapp-form")},300)}function W(r){let e=r.value.replace(/\D/g,"");e.length>2&&(e=e.slice(0,2)+"/"+e.slice(2)),e.length>5&&(e=e.slice(0,5)+"/"+e.slice(5,9)),r.value=e}function F(){var l,h,u,p,m,f,v,g;const r=window.app,e=(l=document.getElementById("whatsapp-name"))==null?void 0:l.value.trim(),t=(h=document.getElementById("whatsapp-city"))==null?void 0:h.value,s=(u=document.getElementById("whatsapp-insurance"))==null?void 0:u.value,i=((p=document.getElementById("whatsapp-intent"))==null?void 0:p.value)||"",a=((m=document.getElementById("whatsapp-topic"))==null?void 0:m.value)||"other",n=(f=document.getElementById("whatsapp-dob"))==null?void 0:f.value;if(!e){r==null||r.toastWarning("Nome obrigatório","Informe o nome do paciente");return}if(!t){r==null||r.toastWarning("Cidade obrigatória","Selecione a cidade");return}let o=i;o+=`

*Nome:* ${e}`,o+=`
*Cidade:* ${t}`,s&&(o+=`
*Convênio:* ${s}`),a==="results"&&n&&(o+=`
*Data de Nascimento:* ${n}`);const d=`https://wa.me/${((g=(v=window.SPA_CONFIG)==null?void 0:v.contacts)==null?void 0:g.whatsappNumber)||"5534999999999"}?text=${encodeURIComponent(o)}`;r==null||r.closeSheet(),setTimeout(()=>{window.open(d,"_blank"),r==null||r.toastSuccess("Abrindo WhatsApp...","")},300)}function H(r){var i,a;const e=window.app,s=`https://wa.me/${((a=(i=window.SPA_CONFIG)==null?void 0:i.contacts)==null?void 0:a.whatsappNumber)||"5534999999999"}?text=${encodeURIComponent(r)}`;e==null||e.closeSheet(),setTimeout(()=>{window.open(s,"_blank"),e==null||e.toastSuccess("Abrindo WhatsApp...","")},300)}function j(r){const e=document.getElementById("theme-toggle-sheet");if(e){const s=JSON.parse(localStorage.getItem("lamarck_settings")||"{}");e.checked=s.theme==="dark"}const t=document.querySelector(".animation-select");if(t){const s=JSON.parse(localStorage.getItem("lamarck_settings")||"{}");t.value=s.animation||"fade"}}window.abrirWhatsAppTopic=z;window.abrirWhatsApp=H;window.maskDob=W;window.submitWhatsAppMiddleware=F;function w(){typeof lucide<"u"&&lucide.createIcons&&lucide.createIcons()}class R{constructor(e){this.app=e,this.db=e.db,this.storage=e.storage,this.cart=[],this.currentProduct=null,this.currentOrderDetail=null,this.currentCompareProduct=null}async init(){console.log("🚀 Inicializando ZePocket...");try{await this._setupDatabase(),this._registerElements(),await this._seedInitialData(),this._bindEvents(),console.log("✅ ZePocket inicializado")}catch(e){console.error("❌ Erro ao inicializar ZePocket:",e),this.app.toastError("Erro","Falha ao inicializar sistema")}}async _setupDatabase(){await this.db.defineTable("zepocket_products",{keyPath:"id",autoIncrement:!1,indexes:[{name:"name",keyPath:"name"},{name:"brand",keyPath:"brand"},{name:"ean",keyPath:"ean",unique:!0}]}),await this.db.defineTable("zepocket_suppliers",{keyPath:"id",autoIncrement:!0,indexes:[{name:"name",keyPath:"name"}]}),await this.db.defineTable("zepocket_quotes",{keyPath:"id",autoIncrement:!1,indexes:[{name:"productId",keyPath:"productId"},{name:"supplierId",keyPath:"supplierId"}]}),await this.db.defineTable("zepocket_orders",{keyPath:"id",autoIncrement:!1,indexes:[{name:"date",keyPath:"date"}]})}_registerElements(){this.app.registerElements({catalogSearch:"catalog-search",catalogList:"catalog-list",cartBadge:"catalog-cart-badge",headerTotalItems:"headerTotalItems",quoteSearch:"quote-search",quotePrice:"quote-cost-price",quoteSalePrice:"quote-sale-price",quoteSupplier:"quote-supplier"})}async _seedInitialData(){if(await this.db.table("zepocket_products").count()===0){console.log("📦 Seed inicial de produtos...");const s=[{id:"SYS-1",ean:"7894900011500",name:"Pepsi Original",brand:"Pepsi",unit:"2L",salePrice:10},{id:"SYS-2",ean:"7894900011517",name:"Coca-Cola Original",brand:"Coca-Cola",unit:"2L",salePrice:12}];for(const i of s)await this.db.table("zepocket_products").upsert(i)}if(await this.db.table("zepocket_suppliers").count()===0){console.log("🏪 Seed inicial de fornecedores...");const s=[{name:"Atacadão Distribuidor"},{name:"Martins Atacado"}];for(const i of s)await this.db.table("zepocket_suppliers").upsert(i)}}_bindEvents(){document.addEventListener("click",e=>{const t=e.target.closest("[data-zepocket-action]");if(!t)return;const s=t.dataset.zepocketAction,i=t.dataset.id,a=t.dataset.value;this.handleAction(s,i,a,t)}),document.addEventListener("input",e=>{e.target.id==="catalog-search"&&this.searchCatalog(e.target.value),e.target.id==="quote-search"&&this.searchQuote(e.target.value),(e.target.id==="quote-cost-price"||e.target.id==="quote-sale-price")&&this.calculateMargin()}),document.addEventListener("page:enter",e=>{var s;const t=(s=e.detail)==null?void 0:s.pageId;t==="catalog"&&this.loadCatalog(),t==="quote"&&this.loadQuote()})}handleAction(e,t,s,i){switch(e){case"toggle-cart":this.toggleCart(t);break;case"remove-from-cart":this.removeFromCart(t);break;case"switch-tab":this.switchTab(s);break;case"update-cart-qty":this.updateCartQuantity(t,i.value);break;case"update-cart-supplier":this.updateCartSupplier(t,i.value);break;case"select-product":this.selectProduct(t);break;case"save-quote":this.saveQuote();break;case"reset-quote":this.resetQuote();break;default:console.warn(`Ação não reconhecida: ${e}`)}}async loadCatalog(){await this.renderCatalog()}async searchCatalog(e){await this.renderCatalog(e)}async renderCatalog(e=""){var o;const t=await this.db.table("zepocket_products").all(),s=e.toLowerCase(),i=t.filter(c=>c.name.toLowerCase().includes(s)),a=this.app.el("catalogList");if(!a)return;if(i.length===0){a.innerHTML='<div class="text-center text-slate-400 py-10">Nada encontrado.</div>';return}let n="";for(const c of i){const d=await this.getBestQuote(c.id),l=this.cart.find(p=>p.productId===c.id),h=d?(o=await this.db.table("zepocket_suppliers").find(d.supplierId))==null?void 0:o.name:"--",u=d?`R$ ${d.price.toFixed(2)}`:"Sem cotação";n+=`
                <div class="bento-card p-4">
                    <div class="flex justify-between items-start">
                        <div>
                            <h3 class="font-bold text-sm">${c.name}</h3>
                            <p class="text-xs text-slate-500">${c.brand} · ${c.unit}</p>
                            <p class="text-xs text-emerald-600 font-bold mt-1">${u}</p>
                            <p class="text-xs text-slate-400">${h}</p>
                        </div>
                        <button 
                            data-zepocket-action="toggle-cart" 
                            data-id="${c.id}"
                            class="p-2 rounded-lg ${l?"bg-emerald-500 text-white":"bg-slate-100 text-slate-600"}">
                            <i class="ph ph-${l?"check":"plus"} text-lg"></i>
                        </button>
                    </div>
                </div>
            `}a.innerHTML=n}async getBestQuote(e){const t=await this.db.table("zepocket_quotes").where("productId",e).all();return t.length===0?null:t.sort((s,i)=>s.price-i.price)[0]}toggleCart(e){const t=this.cart.findIndex(s=>s.productId===e);if(t>-1)this.cart.splice(t,1),this.app.toastSuccess("Removido","Item removido do carrinho");else{const s=this.getBestQuote(e);if(!s){this.app.toastWarning("Aviso","Produto sem cotação");return}this.cart.push({productId:e,supplierId:s.supplierId,qty:1,price:s.price}),this.app.toastSuccess("Adicionado","Item adicionado ao carrinho")}this.updateCartUI()}removeFromCart(e){const t=this.cart.findIndex(s=>s.productId===e);t>-1&&(this.cart.splice(t,1),this.updateCartUI(),this.app.toastSuccess("Removido","Item removido"))}updateCartQuantity(e,t){const s=this.cart.find(i=>i.productId===e);s&&(s.qty=parseInt(t)||1,this.updateCartUI())}updateCartSupplier(e,t){const s=this.cart.find(i=>i.productId===e);s&&(s.supplierId=parseInt(t),this.updateCartUI())}async updateCartUI(){await this.renderCatalog();const e=this.app.el.cartBadge;e&&(this.cart.length>0?(e.textContent=this.cart.length,e.classList.remove("hidden")):e.classList.add("hidden"));const t=this.app.el.headerTotalItems;t&&(t.textContent=this.cart.length)}switchTab(e){["catalogo","carrinho","exportar"].forEach(s=>{const i=document.getElementById(`view-${s}`),a=document.getElementById(`btn-${s}`);i&&i.classList.toggle("hidden",s!==e),a&&(s===e?a.className="active-tab py-2.5 rounded-xl text-xs font-bold transition-all shadow-sm flex flex-col items-center gap-1 relative":a.className="inactive-tab py-2.5 rounded-xl text-xs font-bold transition-all shadow-sm flex flex-col items-center gap-1 relative")})}async loadQuote(){await this.renderSuppliersSelect()}async searchQuote(e){const t=await this.db.table("zepocket_products").all(),s=e.toLowerCase(),i=t.filter(o=>o.name.toLowerCase().includes(s)),a=document.getElementById("suggestionsList");if(!a)return;if(e.length<2){a.classList.add("hidden");return}let n=i.map(o=>`
            <div 
                data-zepocket-action="select-product" 
                data-id="${o.id}"
                class="p-3 hover:bg-slate-50 cursor-pointer border-b border-slate-100">
                <p class="font-bold text-sm">${o.name}</p>
                <p class="text-xs text-slate-500">${o.brand} · ${o.unit}</p>
            </div>
        `).join("");a.innerHTML=n,a.classList.remove("hidden")}async selectProduct(e){var d;if(this.currentProduct=await this.db.table("zepocket_products").find(e),!this.currentProduct)return;const t=document.getElementById("selectedName"),s=document.getElementById("selectedBrand"),i=document.getElementById("selectedUnit"),a=document.getElementById("selectedEan"),n=this.app.el.quoteSalePrice;t&&(t.textContent=this.currentProduct.name),s&&(s.textContent=this.currentProduct.brand),i&&(i.textContent=this.currentProduct.unit),a&&(a.textContent=this.currentProduct.ean||"Sem EAN"),n&&(n.value=((d=this.currentProduct.salePrice)==null?void 0:d.toFixed(2))||"");const o=document.getElementById("quoteFormArea");o&&o.classList.remove("hidden");const c=document.getElementById("suggestionsList");c&&c.classList.add("hidden"),await this.renderSuppliersSelect()}async checkPriceHistory(){const e=document.getElementById("quote-supplier")||document.getElementById("quoteSupplier"),t=document.getElementById("quote-cost-price")||document.getElementById("quotePrice"),s=document.getElementById("priceHint")||document.getElementById("quote-price-hint")||document.getElementById("priceHint");s&&s.classList.add("hidden"),t&&(t.value="");const i=e?parseInt(e.value):null;if(!this.currentProduct||!this.currentProduct.id||!i)return;const a=await this.db.table("zepocket_quotes").where(n=>n.productId===this.currentProduct.id&&n.supplierId===i).all();if(a&&a.length>0){const n=a[0];s&&(s.classList.remove("hidden"),s.textContent=`Último: R$ ${Number(n.price||n.cost_price||0).toFixed(2)}`),t&&n.price&&(t.placeholder=Number(n.price).toFixed(2))}}calculateMargin(){const e=this.app.el.quotePrice,t=this.app.el.quoteSalePrice,s=document.getElementById("marginCard");if(!e||!t||!s)return;const i=parseFloat(e.value),a=parseFloat(t.value);if(isNaN(i)||isNaN(a)||i<=0){s.classList.add("hidden");return}s.classList.remove("hidden");const n=a-i,o=a>0?n/a*100:0,c=document.getElementById("profitValue"),d=document.getElementById("marginPercent");c&&(c.textContent=`R$ ${n.toFixed(2)}`),d&&(d.textContent=`${o.toFixed(1)}%`),n>0?s.className="bg-emerald-100 text-emerald-800 rounded-xl p-3 flex justify-between items-center transition-colors duration-300":n<0?s.className="bg-red-100 text-red-800 rounded-xl p-3 flex justify-between items-center transition-colors duration-300":s.className="bg-slate-100 text-slate-800 rounded-xl p-3 flex justify-between items-center transition-colors duration-300"}async renderSuppliersSelect(){const e=await this.db.table("zepocket_suppliers").all(),t=this.app.el.quoteSupplier;t&&(t.innerHTML=`
            <option value="">Selecione...</option>
            ${e.map(s=>`<option value="${s.id}">${s.name}</option>`).join("")}
        `)}async saveQuote(){const e=this.app.el.quoteSupplier,t=this.app.el.quotePrice,s=this.app.el.quoteSalePrice;if(!e||!t)return;const i=parseInt(e.value),a=parseFloat(t.value),n=parseFloat(s==null?void 0:s.value);if(!i||isNaN(a)){this.app.toastWarning("Aviso","Preencha todos os campos");return}const o=`${this.currentProduct.id}-${i}`;await this.db.table("zepocket_quotes").upsert({id:o,productId:this.currentProduct.id,supplierId:i,price:a,date:new Date().toISOString()}),isNaN(n)||(this.currentProduct.salePrice=n,await this.db.table("zepocket_products").upsert(this.currentProduct)),this.app.toastSuccess("Sucesso","Cotação salva!"),this.resetQuote()}resetQuote(){this.currentProduct=null;const e=document.getElementById("searchInput"),t=document.getElementById("quoteFormArea"),s=this.app.el.quotePrice,i=this.app.el.quoteSalePrice;e&&(e.value=""),t&&t.classList.add("hidden"),s&&(s.value=""),i&&(i.value="")}}document.addEventListener("DOMContentLoaded",async()=>{window.app=new C({homePage:"home",animation:{type:"zoom",speed:.35},ui:{autoTheme:!1},pwa:{enabled:!0,showBanner:!1},db:{name:"supply",version:1},storage:{prefix:"supply_"}}),await app.init(),app,q(app),w();const r=new R(app);await r.init(),window.zepocket=r,app.zepocket=r,window.renderCatalog=e=>r.renderCatalog(e),window.switchTab=e=>r.switchTab(e),window.handleSearch=e=>{try{return app.current==="quote"?r.searchQuote(e):r.searchCatalog(e)}catch{return r.searchCatalog(e)}},window.saveQuote=()=>r.saveQuote(),window.clearSelection=()=>r.resetQuote(),window.checkPriceHistory=()=>r.checkPriceHistory(),console.log({app,zepocket:r});try{typeof b<"u"&&(window.Html5Qrcode=b)}catch(e){console.warn("Could not expose Html5Qrcode to window",e)}document.addEventListener("spa:page-loaded",e=>{try{w()}catch(t){console.warn("initLucide error",t)}});try{const e=function(){let i;return function(){clearTimeout(i),i=setTimeout(()=>{try{w()}catch{}},120)}}();let t=!1;new MutationObserver(i=>{for(const a of i)if(a.addedNodes&&a.addedNodes.length){for(const n of a.addedNodes)if(n.nodeType===1){if(t)return;if(n.matches&&n.matches("[data-lucide]")){t=!0,e(),setTimeout(()=>t=!1,400);return}if(n.querySelector&&n.querySelector("[data-lucide]")){t=!0,e(),setTimeout(()=>t=!1,400);return}}}}).observe(document.body,{childList:!0,subtree:!0})}catch(e){console.warn("Lucide observer init failed",e)}});
